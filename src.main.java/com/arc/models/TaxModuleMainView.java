...
public class TaxModuleMainView implements Serializable{
	
	private static final long serialVersionUID = 1L;

	
	private final IntegerProperty mft_cd;
	...
	private final IntegerProperty expiration_cd;
	...
	public TaxModuleMainView(int mft_cd, int trans_cd, int trans_sub_cd, String locator_no, Date end_dt, String info_text, 
			String posted_cyc_id, Date eff_end_dt, int expiration_cd, String ssn, String account_transaction_sys_id) {
		
		
		this.locator_no = new SimpleStringProperty(locator_no);
        this.ssn = new SimpleStringProperty(ssn);
        this.mft_cd = new SimpleIntegerProperty(mft_cd);
        ...
        this.expiration_cd = new SimpleIntegerProperty(expiration_cd);
        this.account_transaction_sys_id = new SimpleStringProperty(account_transaction_sys_id);
	}
	
	
	public int getmft_cd() {
		return mft_cd.get();
	}

	public void setmft_cd(int mftCd) {
		mft_cd.set(mftCd);
	}
	
	public IntegerProperty mft_cdProperty() {
        return mft_cd;
    }
	
	public int getexpiration_cd() {
		return expiration_cd.get();
	}

	public void setexpiration_cd(int expirationCd) {
		expiration_cd.set(expirationCd);
	}
	
	public IntegerProperty expiration_cdProperty() {
        return expiration_cd;
    }
	...
	@Override
	   public String toString() {
	        return ("TaxModuleMainView:"+this.mft_cd 
	                    );
	   }
